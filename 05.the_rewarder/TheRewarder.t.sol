...
contract TheRewarderChallenge is Test {
    ...
    function test_theRewarder() public checkSolvedByPlayer {
        ...
        uint256 dvtClaimCount = TOTAL_DVT_DISTRIBUTION_AMOUNT / PLAYER_DVT_CLAIM_AMOUNT;
        uint256 wethClaimCount = TOTAL_WETH_DISTRIBUTION_AMOUNT / PLAYER_WETH_CLAIM_AMOUNT;
        uint256 totalClaimCount = dvtClaimCount + wethClaimCount;
        ...
        Claim[] memory claims = new Claim[](totalClaimCount);
